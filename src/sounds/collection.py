...
# print(f"api key: {os.getenv('FREESOUND_API_KEY')}")
...
def collect_sounds(prompt):
    ...
    write_to_file(hi_quality_sounds, os.getenv('SOUND_MAKER_TMP_DIR') + '/sounds.txt')
...
def preview_sound(sound_id):
    ...
    sound.retrieve_preview(directory=os.getenv('SOUND_MAKER_TMP_DIR') + "/", name=f"{sound_id}")
