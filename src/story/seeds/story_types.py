...
child_word_list = [
    "cool", "amazing", "funny", "awesome", "exciting",
    "wonderful", "interesting", "magical", "mysterious", "scary",
    "hilarious", "pretty", "cute", "beautiful", "fantastic",
    "brilliant", "epic", "lovely", "intense", "adventurous",
    "wild", "colorful", "sparkly", "spooky", "great",
    "happy", "sad", "touching", "emotional", "powerful",
    "dramatic", "thrilling", "harrowing", "moving", "heartwarming",
    "silly", "crazy", "fascinating", "surprising", "astonishing",
    "riveting", "joyful", "uplifting", "humorous", "imaginative",
    "creative", "unforgettable", "unique", "original", "twisted",
    "romantic", "sweet", "engaging", "marvelous", "dreamy",
    "action-packed", "delightful", "tender", "intimate", "gripping"
]


adult_word_list = [
    "magical", "adventurous", "whimsical", "funny", "mysterious",
    "colorful", "enchanting", "playful", "exciting", "fantastical",
    "dreamy", "brave", "silly", "heroic", "imaginative",
    "lively", "joyful", "wondrous", "curious", "uplifting",
    "vivid", "captivating", "sparkling", "warm", "cozy",
    "zany", "fanciful", "delightful", "inspiring", "quirky",
    "sweet", "heartwarming", "intriguing", "happy", "bright",
    "dynamic", "energetic", "comical", "engaging", "charming",
    "endearing", "gentle", "daring", "bold", "friendly",
    "musical", "animated", "rhythmic", "bubbly", "lovable",
    "soft", "shiny", "jolly", "spirited", "fluffy",
    "smooth", "glowing", "spunky", "feisty", "cheerful"
]
...
concept_list = [
    "The dragon who befriended a butterfly",
    "The teddy bear's magical adventure",
    "A day in the life of a talking toy",
    "Molly's trip to the moon with her pet cat",
    "The rainbow slide that led to another world",
    "The secret city of toys hidden in the attic",
    "Timmy's shoes that could walk and talk",
    "The little robot that wanted to dance",
    "The magical treehouse in the enchanted forest",
    "The unicorn that lost its sparkle",
    "Liam and the giant jelly bean",
    "Sofia's underwater adventure with mermaids",
    "The day all the zoo animals decided to swap places",
    "The chocolate river of Willy Wonkytown",
    "Lucy and the talking snowman",
    "Sam's mysterious adventure inside a book",
    "The magical balloon ride around the world",
    "The penguin who wanted to live in the desert",
    "The adventures of Captain Kitty the pirate",
    "The golden key that opened doors to different times",
    "The enchanted garden where flowers sang",
    "Ben's journey with the time-traveling train",
    "Olivia and the giant's friendly game of hide and seek",
    "The mouse who dreamed of being a lion",
    "The island where all the lost toys lived",
    "Amy's day out with the sun and moon",
    "The candy that makes you see in colors",
    "The star that fell from the night sky",
    "A school where all the students are animals",
    "The little cloud that wanted to rain candy",
    "The magical door at the back of grandma's closet",
    "A world where everyone's reflection came to life",
    "Daisy's adventure in the land of dreams",
    "The curious case of the dancing shoes",
    "Billy's journey to find the end of the rainbow",
    "The bakery where pastries talked and laughed",
    "Emma and the chocolate rainstorm",
    "A trip to a planet made of candy",
    "The magical bird that sang stories from the past",
    "The friendly ghost that loved to play games",
    "The great cake race of Caketown",
    "The baby dragon that mistook a kite for its mother",
    "A picnic on a floating island in the sky",
    "The roller-skating squirrel's big show",
    "The bunny that could paint pictures with its tail",
    "An amusement park run by wizards and witches",
    "The great toy rebellion in Toyland",
    "Hannah and her magic bubble-blowing wand",
    "The playground where swings flew to the clouds",
    "The little alien who visited Earth on vacation",
    "The boy who could change the weather with his moods",
    "The lost city of cookies under the bed",
    "An adventure with the fairy of forgotten things",
    "The parade of dreams in Sleepytown",
    "A world where every child had a magic power",
    "A concert where animals played the instruments",
    "The treasure map found in an old comic book",
    "Lily's day as a queen in a castle made of pillows",
    "The day the sun and moon decided to switch places",
    "A mysterious island where shadows had a life of their own",
    "The adventure of a lifetime inside a giant snow globe",
    "The story of the bravest teddy bear in the world"
]
